  ...
  return (
    <div className="content-page">
      ...
      <Form layout="inline" className="mb-4 flex flex-wrap gap-2">
        ...
        <Form.Item label={DTR_DETAIL_LABEL.FILTER_DEPARTMENT}>
          <Select
            allowClear
        ...
        <Form.Item label={DTR_DETAIL_LABEL.FILTER_CLIENT}>
          <Select
            allowClear
        ...
        <Form.Item label={DTR_DETAIL_LABEL.FILTER_EMPLOYEE}>
          <Select
            allowClear
        ...
        <Form.Item label={DTR_DETAIL_LABEL.FILTER_PAYROLL_GROUP}>
          <Select
            allowClear
