...
} from "../../models/forms/payroll-settings-form.schema";
import {
  usePayrollSettings,
  useUpdatePayrollSettings,
} from "../../hooks/use-payroll-settings-queries";
  ...
  return (
    <div className="p-6 max-w-3xl flex flex-col gap-6">
      <div>
        ...
        <Text type="secondary">
          Configure fiscal year and statutory computation rules.
        </Text>
      </div>
      ...
      <Form layout="vertical" onFinish={handleSubmit(onSubmit)}>
        ...
        <Card size="small" title="Fiscal Year" className="mb-4">
          <div className="flex flex-col gap-1 mb-4">
            <Text type="secondary" className="text-sm">
              Defines the 12-month period used for payroll year-end
              calculations. The fiscal year ends on the last day of the month
        ...
        >
          <div className="flex flex-col gap-1 mb-4">
            <Text type="secondary" className="text-sm">
              Under the TRAIN Law (BIR), the combined total of 13th month pay
              and other benefits up to the exemption ceiling is non-taxable. Any
          ...
          <Form.Item
            ...
            validateStatus={
              errors.thirteenthMonthExemptionCeiling ? "error" : ""
            }
          ...
          <Alert
            ...
            description={
              <div className="flex flex-col gap-1 text-sm mt-1">
                ...
                <Text>
                  If{" "}
                  <strong>(13th Month + Special Bonuses) &gt; ceiling</strong> →
